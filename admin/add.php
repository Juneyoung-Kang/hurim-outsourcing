                        ...
                        <h4 class="ui dividing header">제품 정보</h4>
                          ...
                          <div class="field">
                            ...
                            <div class="six fields">
                              <div class="field">
                                <input type="number" name="fixed1" placeholder="가로x세로">
                              </div>
                              <div class="field">
                                <input type="number" name="fixed2" placeholder="가로x세로">
                              </div>
                              <div class="field">
                                <input type="number" name="fixed3" placeholder="가로x세로">
                              </div>
                              <div class="field">
                                <input type="number" name="fixed4" placeholder="가로x세로">
                              </div>
                              <div class="field">
                                <input type="number" name="fixed5" placeholder="가로x세로">
                              </div>
                              <div class="field">
                                <input type="number" name="fixed6" placeholder="가로x세로">
                              </div>
                            </div>
                          </div>
